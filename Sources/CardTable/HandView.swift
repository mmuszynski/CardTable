...
public struct HandView<CardType: Card>: View {
    ...
    var cardOffsets: [CGFloat] {
        ...
        let initialOffset = CGFloat(self.cards.count / 2) * perCardOffsetAmount - 50
        var output: [CGFloat]
...
struct HandView_Previews: PreviewProvider {
    static var previews: some View {
        let deck = Deck(PlayingCard.fullDeck[0..<20]).sorted(by: PlayingCard.defaultAscendingOrder)
